	...
	public function like_button(){
		...
		if(($this->capabilities === 'users-only' && $this->user_is_loggedin) || $this->capabilities === 'all'){
			if(!$this->check_recurring_like()){
				...
				// like button
				$button =  '<div class="vote" id="wizylike-post-'.$this->post_id.'"><a href="#" onclick="javascript:return false;">' . "\n";
				$button .= "\t" . '<span class="icon-like" onclick="'.$onclick_like.'">&nbsp;</span>' . "\n";
				...
				$button = '<div class="likecont" id="wizylike-post-'.$this->post_id.'"><a href="#" onclick="'.$onclick_like.'; javascript:return false;" class="vote icon-like wizylike_like_unlike"><span class="wizylike_count">'.$this->likes_count.'</span></a></div>';
				...
				// like button
				$button =  '<li class="wizylike_button '.$this->style.' light_bg '.$this->colour.'" id="wizylike-post-'.$this->post_id.'"><a href="#" onclick="javascript:return false;">' . "\n";
				$button .= "\t" . '<span class="icon-like" onclick="'.$onclick_unlike.'">&nbsp;</span>' . "\n";
				$button .= "\t" . '<span class="wizylike_count">'.$this->likes_count.'</span>' . "\n";
				$button .= "\t" . '<span class="wizylike_like_unlike" onclick="'.$onclick_unlike.'">'.$this->unlike_txt.'</span>' . "\n";
				$button .= '</a></li>' . "\n";
				
				$button = '<div class="likecont" id="wizylike-post-'.$this->post_id.'"><a href="#" onclick="'.$onclick_unlike.'; javascript:return false;" class="vote icon-like wizylike_like_unlike"><span class="wizylike_count">'.$this->likes_count.'</span></a></div>';
			
			}
		} elseif(($this->capabilities === 'users-only' && !$this->user_is_loggedin)) {
			
			// count
			$button =  '<li class="wizylike_button '.$this->style.' light_bg '.$this->colour.' modal" id="wizylike-post-'.$this->post_id.'"><a href="#" onclick="javascript:return false;">' . "\n";
			$button .= "\t" . '<span class="icon-like">&nbsp;</span>' . "\n";
