...
function optionsframework_adminbar() {
	...
	add_root_menu("FolioGrid Pro", "frogsthemes", "admin.php?page=frogsthemes");
    add_sub_menu("Theme Options", "admin.php?page=frogsthemes", "frogsthemes");
	#add_sub_menu("Sidebar Manager", "admin.php?page=frogsthemes_sidebar", "frogsthemes");
	#add_sub_menu("Ads Manager", "admin.php?page=frogsthemes_ads", "frogsthemes");
	add_sub_menu("FT Installer", "admin.php?page=frogsthemes_installer", "frogsthemes");
}
    ...
    <div id="of_container">
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
		  ...
		  <div class="version">
		  <?php esc_html_e( $themename ); ?><br /><span>Version 1.0.0</span>
		  </div>
          <div class="clear"></div>
        </div>
		<div id="headernav">
			<ul>
				<li class="changelog"><a href="http://wiki.frogsthemes.com/our-themes/foliogrid-pro/foliogrid-pro-changelog" target="_blank">View Changelog</a></li>
				<li class="themedocs"><a href="http://www.frogsthemes.com/support/" target="_blank">View Theme Docs</a></li>
