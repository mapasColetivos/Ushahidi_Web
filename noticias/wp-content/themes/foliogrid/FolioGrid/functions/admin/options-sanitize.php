...
function of_sanitize_typography_r( $input ) {
	$output = wp_parse_args( $input, array(
		'face'  => '',
		'style' => '',
		'color' => ''
...
add_filter( 'of_sanitize_typography_r', 'of_sanitize_typography_r' );

/* Typography_r_2 */

function of_sanitize_typography_r_2( $input ) {
	$output = wp_parse_args( $input, array(
		'face'  => '',
		'style' => '',
		'color' => ''
...
add_filter( 'of_sanitize_typography_r_2', 'of_sanitize_typography_r_2' );
...
function of_recognized_font_faces_reduced() {
	return array(
		'arial'     => 'Arial',
		'verdana'   => 'Verdana, Geneva',
		'trebuchet' => 'Trebuchet',
