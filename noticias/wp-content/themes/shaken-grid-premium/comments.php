...
?>
			...
			<div id="comments"<?php if( !have_comments() ){ echo ' class="no-comments"'; } ?>>
...
<?php if ( have_comments() ) : ?>
			<h2 id="comments-title"><?php _e('What Others Are Saying', 'shaken'); ?></h2>
...
<?php else : // or, if we don't have comments: ?>
	...
	<h2 id="comments-title"><?php _e('Be the first to leave a comment', 'shaken'); ?></h2>
