 ...
 * 
 * PHP version 5 LICENSE: This source file is subject to LGPL license that is
...
?>
		...
		jQuery(function() {
			/*
			 * - Initialize Map - Uses Spherical Mercator Projection - Units in
			...
			/*
			 * - Select A Mapping API - Live/Yahoo/OSM/Google - Set Bounds
			 */
			...
			/*
			 * Google GeoCoder TODO - Add Yahoo and Bing Geocoding Services
			 */
