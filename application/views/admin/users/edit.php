 ...
 * @package    Ushahidi
 * @link       http://github.com/ushahidi/Ushahidi_Web
...
<div class="bg">
	...
	<div class="report-form">
		...
		<div class="sms_holder">
			...
			<div class="row">
				<h4>
					<a href="#" class="tooltip" title="<?php echo Kohana::lang("tooltips.profile_public_url"); ?>">
			...
			<div class="row">
				<h4>
					<a href="#" class="tooltip" title="<?php echo Kohana::lang("tooltips.profile_new_users_password"); ?>">
