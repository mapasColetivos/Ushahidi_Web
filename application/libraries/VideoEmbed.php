...
class VideoEmbed{
   ...
   function embed($raw, $auto, $width=320, $height=265)
   {
	  $host = "";
      //clean the raw data
      $raw = trim($raw);
      ...
      if($host == "youtube")
      {
         ...
         if($auto == "play") { $you_auto = "&autoplay=1"; }
      	 ...
      	 $youtube_video_code = $matches[1];
         echo "
         <iframe class='hooverable delimiter' width='$width' height='$height' src='http://www.youtube.com/embed/$youtube_video_code?wmode=transparent' frameborder='0' allowfullscreen></iframe>
         ";
      }
