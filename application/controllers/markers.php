...
class Markers_Controller extends Template_Controller
{
    ...
    {       
        ...
        foreach (ORM::factory('category')->where($filter_cat)->orderby('category_title', 'asc')->find_all() as $category)
        {
            ...
            $style_map .= "<Icon>\n";
            $style_map .= "<href>" . htmlentities(url::base() . "index.php/swatch/?c=" . $category->category_color . "&w=16&h=16&.png") . "</href>\n";
            $style_map .= "</Icon>\n";
            $style_map .= "</IconStyle>\n";
            $style_map .= "</Style>\n";
        }
    ...
    function single ( $incident_id = false )
    {
        ...
        $style_map .= "<scale>0.5</scale>\n";
        $style_map .= "<Icon>\n";
        $style_map .= "<href>" . htmlentities(url::base() . "index.php/swatch/?c=CC0000&w=16&h=16&.png") . "</href>\n";
        $style_map .= "</Icon>\n";
        $style_map .= "</IconStyle>\n";
        $style_map .= "</Style>\n";
        ...
        $style_map .= "<scale>0.5</scale>\n";
        $style_map .= "<Icon>\n";
        $style_map .= "<href>" . htmlentities(url::base() . "index.php/swatch/?c=FF9933&w=16&h=16&.png") . "</href>\n";
        $style_map .= "</Icon>\n";
        $style_map .= "</IconStyle>\n";
        $style_map .= "</Style>\n";
