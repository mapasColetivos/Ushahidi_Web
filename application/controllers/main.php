...
class Main_Controller extends Template_Controller {
    ...
    public function index()
    {
		...
		$query = $db->query('SELECT incident_date, count(*) AS incident_count FROM '.$this->table_prefix.'incident WHERE incident_active = 1 AND incident_privacy = 0 GROUP BY DATE_FORMAT(incident_date, \'%Y-%m\') ORDER BY incident_count DESC LIMIT 1');
...
"/index.php/json/cluster" : "/index.php/json";
		...
		$this->themes->js->locations = ORM::factory("location")->find_all();
