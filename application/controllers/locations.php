...
class Locations_Controller extends Main_Controller {
	...
	public function kml_delete($layer_id = false, $incident_id = false){
		ORM::factory('incident_kml')->where('incident_id',$incident_id)->where('kml_id',$layer_id)->delete_all();
	...
	public function add_location(){
		...
		$location = $this->_save_new_location($_POST["name"],$_POST['latitude'],$_POST['longitude'],$_POST['layer_id'],$_POST['incident_id']);
